...
{
	// 4.5
	if (GuiBackend::Instance()->IsGlversionSupported(4, 5)) { *vMajor = 4; *vMinor = 5; return; }
	// 4.4
	if (GuiBackend::Instance()->IsGlversionSupported(4, 4)) { *vMajor = 4; *vMinor = 4; return; }
	// 4.3 => compute
	if (GuiBackend::Instance()->IsGlversionSupported(4, 3)) { *vMajor = 4; *vMinor = 3; return; }
	// 4.2
	if (GuiBackend::Instance()->IsGlversionSupported(4, 2)) { *vMajor = 4; *vMinor = 2; return; }
	// 4.1
	if (GuiBackend::Instance()->IsGlversionSupported(4, 1)) { *vMajor = 4; *vMinor = 1; return; }
	// 4.0 => tesselation
	if (GuiBackend::Instance()->IsGlversionSupported(4, 0)) { *vMajor = 4; *vMinor = 0; return; }
	// 3.3 => attrcib lcoation in core
	if (GuiBackend::Instance()->IsGlversionSupported(3, 3)) { *vMajor = 3; *vMinor = 3; return; }
	// 3.2 => attrib location in extention
	if (GuiBackend::Instance()->IsGlversionSupported(3, 2)) { *vMajor = 3; *vMinor = 2; return; }
...
int main(int, char** argv)
{
	...
	if (MainBackend::sMainThread.win)
	{
		...
		//ImGui::GetIO().Fonts->AddFontFromMemoryCompressedBase85TTF(FONT_ICON_BUFFER_NAME_NDPTB, 20.0f, &icons_config, icons_ranges3);
