...
enum class SettingsPaneModeEnum { SETTINGS_PANE_MODE_CONTENT = 0, SETTINGS_PANE_MODE_LOAD, SETTINGS_PANE_MODE_SAVE, SETTINGS_PANE_MODE_Count };
...
protected:
    ...
    SettingsDlg& operator=(const SettingsDlg&) {
        return *this;
    };               // Prevent assignment
