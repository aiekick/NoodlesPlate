...
bool PixelDebug::IsActive() {
    return puMouseDebugPoint.IsActive() || puLineDebugPoint.IsActive() || puNormalDebugPoint.IsActive() || puGizmoDebugPoint.IsActive();
}
...
bool PixelDebug::NeedRefresh() {
    return puLineDebugPoint.NeedRefresh() || puMouseDebugPoint.NeedRefresh() || puNormalDebugPoint.NeedRefresh() || puGizmoDebugPoint.NeedRefresh();
}
