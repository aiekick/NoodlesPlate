        ...
        if (ImGui::Begin(GetName().c_str(), vOpened, flags)) {
            ...
            if (ImGui::BeginTabBar("Shaders")) {
                if (ImGui::BeginTabItem("Main")) {
                    InterfacePanes::Instance()->DisplayScriptCode(
                        MainBackend::sMainThread, MainBackend::Instance()->puCodeTree, MainBackend::Instance()->puDisplay_RenderPack, true);
                    ImGui::EndTabItem();
                }
...
TextEditor* CodePane::GetEditor() {
    return &InterfacePanes::Instance()->puTextEditor;
}
