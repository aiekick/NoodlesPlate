...
bool HelpPane::DrawPanes(const uint32_t& /*vCurrentFrame*/, bool* vOpened, ImGuiContext* /*vContextPtr*/, void* /*vUserDatas*/)
{
	if (vOpened && *vOpened)
	{
        ...
        if (ImGui::Begin(GetName().c_str(), vOpened, flags))
		{
			...
			InterfacePanes::Instance()->DisplayScriptHelp(MainBackend::Instance()->puCodeTree, MainBackend::Instance()->puDisplay_RenderPack);
		}
